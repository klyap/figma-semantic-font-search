...
This is an Figma AI plugin that lets you search for fonts based on vibe/descriptions, as opposed to font names directly.

It doesn't not require any OpenAI API keys, etc.

It is based on [https://github.com/figma/ai-plugin-template](https://github.com/figma/ai-plugin-template)

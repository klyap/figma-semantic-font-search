...
fetchFontSpecimens().then(({ fontSpecimens, missingFontSpecimens }) => {
  ...
  fs.writeFileSync('fonts-metadata.js', "export const fontMedata = " + JSON.stringify(fontSpecimens, null, 2));
  fs.writeFileSync('missing-fonts.js', JSON.stringify(missingFontSpecimens, null, 2));
